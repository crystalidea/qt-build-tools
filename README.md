...
- Modern, compiled with [Qt 5.15.17](5.15.17) for macOS 10.13+. The folder contains several macOS-related patches. It can be compiled on any modern macOS version using any XCode version.
