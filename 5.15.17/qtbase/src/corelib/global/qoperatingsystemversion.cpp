...
const QOperatingSystemVersion QOperatingSystemVersion::MacOSSonoma = [] {
        return QOperatingSystemVersion(QOperatingSystemVersion::MacOS, 14, 0);
}();

const QOperatingSystemVersion QOperatingSystemVersion::MacOSTahoe = [] {
        return QOperatingSystemVersion(QOperatingSystemVersion::MacOS, 26, 0);
}();
